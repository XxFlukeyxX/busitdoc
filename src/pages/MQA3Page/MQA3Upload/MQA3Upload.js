...
const MQA3Upload = () => {
  ...
  return (
    <div className="mqa3-upload-container">
      {/* หัวข้อใหญ่ */}
      <h2 className="Upload-page-title">
        แบบบันทึกข้อมูล มคอ.3 ประจำภาคการศึกษา ที่ 2 ปีการศึกษา 2567
      </h2>

      {/* ส่วนของเอกสาร */}
      <div className="document-section">
        <h3 className="document-title">เอกสาร มคอ.3</h3>
      ...
      {showModal && (
        <div className="modal-overlay">
          <div className="modal-content">
            ...
            <button className="confirm-button" onClick={() => navigate("/MQA3")}>
              ยืนยัน
            </button>
          </div>
        </div>
