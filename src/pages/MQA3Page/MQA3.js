...
import "../../pages/MQA3Page/MQA3.css"; // เรียกใช้ CSS
...
const MQA3 = () => {
  ...
  const fetchSubjects = () => {
    ...
    axios
      .get("https://your-api-url.com/mqa3-data")
      .then((response) => {
  ...
  return (
    <div className="mqa3-container">
      {/* ✅ ส่วนหัวของเอกสาร */}
      <h2 className="table-title-mqa3">
        แบบบันทึกข้อมูล มคอ. 3 <br />
        ประจำภาคการศึกษาที่ 2 ปีการศึกษา 2567
      </h2>

      {/* ✅ กล่องของตาราง */}
      <div className="table-container-mqa3">
        <table>
          <thead>
            <tr>
              <th>ลำดับ</th>
