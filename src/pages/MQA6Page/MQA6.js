...
import "../../pages/MQA6Page/MQA6.css"; // เรียกใช้ CSS
...
const MQA6 = () => {
  ...
  const fetchSubjects = () => {
    ...
    axios
      .get("https://your-api-url.com/mqa6-data")
      .then((response) => {
  ...
  return (
    <div className="mqa6-container">
      {/* ✅ ส่วนหัวของเอกสาร */}
      <h2 className="table-title-mqa6">
        แบบบันทึกข้อมูล มคอ. 6 <br />
        ประจำภาคการศึกษาที่ 2 ปีการศึกษา 2567
      </h2>

      {/* ✅ กล่องของตาราง */}
      <div className="table-container-mqa6">
        <table>
          <thead>
            <tr>
              <th>ลำดับ</th>
