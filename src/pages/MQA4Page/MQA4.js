...
import "../../pages/MQA4Page/MQA4.css"; // เรียกใช้ CSS
...
const MQA4 = () => {
  ...
  const fetchSubjects = () => {
    ...
    axios
      .get("https://your-api-url.com/mqa4-data")
      .then((response) => {
  ...
  return (
    <div className="mqa4-container">
      {/* ✅ ส่วนหัวของเอกสาร */}
      <h2 className="table-title-mqa4">
        แบบบันทึกข้อมูล มคอ. 4 <br />
        ประจำภาคการศึกษาที่ 2 ปีการศึกษา 2567
      </h2>

      {/* ✅ กล่องของตาราง */}
      <div className="table-container-mqa4">
        <table>
          <thead>
            <tr>
              <th>ลำดับ</th>
